                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 col-xs-12">
                            <div class="checkout-title">
                                <h3 class="text-title">BILLING <span>DETAILS</span></h3></div>
                            <div class="row check-out">
                                ...
                                <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" name="field-name" value="" placeholder="State / County">
                                </div>
                                <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                    <div class="field-label">Postal Code</div>
                                    <input type="text" name="field-name" value="" placeholder="Postal Code">
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
                            <div class="checkout-details">
                                <div class="order-box">
                                    ...
                                    <ul class="qty">
                                        <li>Pink Slim Shirt × 1 <span><i class="fa fa-inr" aria-hidden="true"></i>25.10</span></li>
                                        <li>SLim Fit Jeans × 1 <span><i class="fa fa-inr" aria-hidden="true"></i>555.00</span></li>
                                    </ul>
                                    <ul class="sub-total">
                                        <li>Subtotal <span class="count"><i class="fa fa-inr" aria-hidden="true"></i>380.10</span></li>
                                        <li>Shipping
                                            <div class="shipping">
                                    ...
                                    <ul class="total">
                                        <li>Total <span class="count"><i class="fa fa-inr" aria-hidden="true"></i>620.00</span></li>
                                    </ul>
                                </div>
