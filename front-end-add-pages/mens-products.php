...
<head>
    ...
    <meta name="description" content="Filsrich provides Wholesale Mens Clothing of great quality with lowest  price. We are jeans, shirt,trousers, shorts, t-shirts, neckties, men inner-wear, and shirts Manufacturers and wholesalers for all retailers.">
    <meta name="keywords" content="wholesale women clothing,bulk wholesale clothing distributors,buy wholesale clothing,wholesale e-commerce marketplace,buy wholesale products">
    ...
    <title>Purchase Mens clothing b2b online store - Filsrich</title>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="product-slick">
                        <div><img src="assets/images/pro3/1.jpg" alt="" class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                        <div><img src="assets/images/pro3/2.jpg" alt="" class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                        <div><img src="assets/images/pro3/27.jpg" alt="" class="img-fluid blur-up lazyload image_zoom_cls-2"></div>
                        <div><img src="assets/images/pro3/27.jpg" alt="" class="img-fluid blur-up lazyload image_zoom_cls-3"></div>
                    </div>
                    <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="product-right product-description-box">
                        <h2>Men's Pink Shirt</h2>
                        <div class="rating three-star mb-2"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
