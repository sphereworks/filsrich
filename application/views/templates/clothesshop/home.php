                    ...
                    <div class="theme-tab">
                        <div class="tab-content-cls">
                            <div class="tab-content active default" >
                                <?php if($arrCategories){ foreach ($arrCategories as $cat) { 
                                  $cat_name = explode( ' ' ,$cat['name'] )
                                    ?>
                                    <div class="text-title1"><a href="all-mens-products.php"><?php echo $cat_name[0].' '; ?><span><?php echo $cat_name[1]; ?></span></a></div>
                                    <div class="no-slider row">
                                        <?php
                                        if (!empty($products)) {
                                            $load::getProducts($products, $cat['id'] , 'col-sm-4 col-md-3', false);
                                        } else {
                                            ?>
                                            <script>
