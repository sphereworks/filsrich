                            ...
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Earnings</span>
                                        <h3 class="mb-0"><i class="fa fa-inr" aria-hidden="true"></i> <span class="counter">6659</span><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Products</span>
                                        <h3 class="mb-0"><i class="fa fa-inr" aria-hidden="true"></i> <span class="counter">9856</span><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Messages</span>
                                        <h3 class="mb-0"><i class="fa fa-inr" aria-hidden="true"></i> <span class="counter">893</span><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-danger card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">New Vendors</span>
                                        <h3 class="mb-0"><i class="fa fa-inr" aria-hidden="true"></i> <span class="counter">45631</span><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="user-status table-responsive latest-order-table">
                                    <table class="table table-bordernone">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td class="digits"><i class="fa fa-inr" aria-hidden="true"></i>120.00</td>
                                            <td class="font-danger">Bank Transfers</td>
                                            <td class="digits">On Way</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td class="digits"><i class="fa fa-inr" aria-hidden="true"></i>90.00</td>
                                            <td class="font-secondary">Ewallets</td>
                                            <td class="digits">Delivered</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td class="digits"><i class="fa fa-inr" aria-hidden="true"></i>240.00</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="digits"><i class="fa fa-inr" aria-hidden="true"></i>6523</td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                            <td class="digits"><i class="fa fa-inr" aria-hidden="true"></i>50.00</td>
                                        ...
                                        <div class="order-graph">
                                            ...
                                            <div class="order-graph-bottom">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-0">Saint Lucia <span class="pull-right"><i class="fa fa-inr" aria-hidden="true"></i>157</span></h6>
                                                    </div>
                                                </div>
                                                <div class="media">
                                                    <div class="order-color-secondary"></div>
                                                    <div class="media-body">
                                                        <h6 class="mb-0">Kenya <span class="pull-right"><i class="fa fa-inr" aria-hidden="true"></i>347</span></h6>
                                                    </div>
                                                </div>
                                                <div class="media">
                                                    <div class="order-color-danger"></div>
                                                    <div class="media-body">
                                                        <h6 class="mb-0">Liberia<span class="pull-right"><i class="fa fa-inr" aria-hidden="true"></i>468</span></h6>
                                                    </div>
                                                </div>
                                                <div class="media">
                                                    <div class="order-color-warning"></div>
                                                    <div class="media-body">
                                                        <h6 class="mb-0">Christmas Island<span class="pull-right"><i class="fa fa-inr" aria-hidden="true"></i>742</span></h6>
                                                    </div>
                                                </div>
                                                <div class="media">
                                                    <div class="order-color-success"></div>
                                                    <div class="media-body">
                                                        <h6 class="mb-0">Saint Helena <span class="pull-right"><i class="fa fa-inr" aria-hidden="true"></i>647</span></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
